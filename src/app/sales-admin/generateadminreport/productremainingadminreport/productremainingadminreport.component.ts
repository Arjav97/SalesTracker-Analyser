...
@Component({
  selector: 'app-productremainingadminreport',
  templateUrl: './productremainingadminreport.component.html',
  styleUrls: ['./productremainingadminreport.component.css']
})
export class ProductremainingadminreportComponent implements OnInit {
