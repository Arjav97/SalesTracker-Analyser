...
@Component({
  selector: 'app-salesrepadminreport',
  templateUrl: './salesrepadminreport.component.html',
  styleUrls: ['./salesrepadminreport.component.css']
})
export class SalesrepadminreportComponent {
  ...
  salesrepadmin(date1,date2,salesrep:string):void
  {
    ...
    {
      UIkit.notification({message:`<span uk-icon="icon:close;ratio:2"></span>Missing Sales Representative`,status:'danger',pos:'top-center',timeout:1000});
    }
    else
    {
